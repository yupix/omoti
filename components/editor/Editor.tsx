...
import { Download, Layers, Box, Plus, Trash2, Calendar, FileText, Video as VideoIcon, Image as ImageIcon, Play, Pause, SkipBack, SkipForward } from 'lucide-react';
...
export default function Editor() {
    ...
    const addClip = (type: ClipType) => {
        const newClip: Clip = {
            ...
            type,
            trackId: type === 'text' ? 1 : 2,
            startFrame: currentFrame, // Place at playhead
            durationInFrames: 60,
            content: type === 'text' ? 'New Text' : 'https://picsum.photos/seed/picsum/800/450',
            title: `New ${type}`,
        };
